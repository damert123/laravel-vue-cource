        ...
        <div class="max-w-2xl mx-auto bg-white rounded-xl shadow-md overflow-hidden">
            <div class="p-6">
                ...
                <div class="text-sm text-gray-500 mb-4">
                    ...
                    <span>By Profile ID: {{ post.profile_id }}</span>
                </div>
                ...
                <div class="flex items-center justify-between space-x-6">
                    ...
                    <div class="flex items-center space-x-6">
                        ...
                        <button class="flex items-center space-x-2 text-gray-700 hover:text-blue-600 transition duration-150 ">
                        ...
                        <button class="flex items-center space-x-2 text-gray-700 hover:text-blue-600 transition duration-150">
                            <svg v-if="!isShowed" @click="getComments(post)" class="w-6 h-6" viewBox="0 0 42 42" fill="none" stroke="currentColor" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <svg v-if="isShowed" @click="isShowed = false" class="w-6 h-6" viewBox="0 0 42 42" fill="none" stroke="currentColor" xmlns="http://www.w3.org/2000/svg">
                                <path stroke-width="4.16667" stroke-linecap="round" stroke-linejoin="round" d="M21 39.75C24.7084 39.75 28.3335 38.6503 31.4169 36.5901C34.5004 34.5298 36.9036 31.6014 38.3227 28.1753C39.7419 24.7492 40.1132 20.9792 39.3897 17.3421C38.6663 13.7049 36.8805 10.364 34.2582 7.74176C31.636 5.11952 28.2951 3.33376 24.6579 2.61028C21.0208 1.88681 17.2508 2.25812 13.8247 3.67727C10.3986 5.09641 7.47022 7.49964 5.40995 10.5831C3.34967 13.6665 2.25 17.2916 2.25 21C2.25 24.1 3 27.0229 4.33333 29.5979L2.25 39.75L12.4021 37.6667C14.9771 39 17.9021 39.75 21 39.75Z" />
                            </svg>
                    ...
                    <div class="flex items-center space-x-2 text-gray-700  ">
                        <svg class="w-6 h-6" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M24.9668 10.9375C17.3554 10.9375 9.54782 15.3428 3.40134 24.1533C3.22589 24.4076 3.12975 24.7081 3.12506 25.017C3.12037 25.3259 3.20733 25.6292 3.37497 25.8887C8.09763 33.2813 15.8008 39.0625 24.9668 39.0625C34.0332 39.0625 41.8945 33.2637 46.6259 25.8545C46.7897 25.6001 46.8767 25.304 46.8767 25.0015C46.8767 24.6989 46.7897 24.4028 46.6259 24.1484C41.8838 16.8242 33.9648 10.9375 24.9668 10.9375Z" stroke="black" stroke-width="3.125" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M25 32.8125C29.3147 32.8125 32.8125 29.3147 32.8125 25C32.8125 20.6853 29.3147 17.1875 25 17.1875C20.6853 17.1875 17.1875 20.6853 17.1875 25C17.1875 29.3147 20.6853 32.8125 25 32.8125Z" stroke="black" stroke-width="3.125" stroke-miterlimit="10"/>
                        </svg>
            ...
            <div v-if="comments && isShowed">
                <div v-for="comment in comments" class="mt-4 p-2 border rounded-lg">
                    <strong>{{ comment.profile_id }}</strong>: {{ comment.title }}
                </div>
            </div>
        </div>
    </div>
